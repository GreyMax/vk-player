...
public class JSuggestField extends JTextField {
    ...
    public JSuggestField(Frame owner) {
        ...
        addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                if (getText().equals("Type login here...")) {
                    setText("");
                }
     ...
     */
    public void showSuggest(boolean isDoubleClick) {
        ...
        matcher = new InterruptableMatcher(isDoubleClick);
        //matcher.start();
    ...
    private class InterruptableMatcher extends Thread {
        ...
        public InterruptableMatcher(boolean isDoubleClick) {
        ...
        public void run() {
            try {
                ...
                if (suggestions.size() > 0) {
                    ...
                    if (word.length() > 0 || isDoubleClick) {
                        d.setVisible(true);
                    } else {
                        d.setVisible(false);
                    }
